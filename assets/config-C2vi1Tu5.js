const e={personal:{name:"Soham",title:"Developer & Creator",description:"Passionate about building innovative digital experiences",email:"your.email@example.com",linkedin:"https://linkedin.com/in/yourprofile",github:"https://github.com/yourusername"},layout:{fieldSize:40,tableSpacing:8,tableHeight:1.2,maxTablesPerRow:3},exhibits:[{id:"contact",title:"Get In Touch",category:"Connect",position:{x:0,z:15},shortDescription:"Let's work together",content:`
                <h3>Let's Connect!</h3>
            ...
            `,icon:"🏆"}]};export{e as PORTFOLIO_CONFIG};
